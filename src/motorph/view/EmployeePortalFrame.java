...
public class EmployeePortalFrame extends BaseAppFrame {
    ...
    private void openAttendanceDialog() {
        ...
        btnIn.addActionListener(e -> {
            ...
            String err = ar.clockIn(user.getEmployeeNumber(), lastName, firstName, timeStr);
            if (err != null)
                JOptionPane.showMessageDialog(dialog, err, "Cannot Clock In", JOptionPane.WARNING_MESSAGE);
            else
        ...
        btnOut.addActionListener(e -> {
            String timeStr = LocalTime.now().format(DateTimeFormatter.ofPattern("H:mm"));
            String err = ar.clockOut(user.getEmployeeNumber(), timeStr);
            if (err != null)
                JOptionPane.showMessageDialog(dialog, err, "Cannot Clock Out", JOptionPane.WARNING_MESSAGE);
            else
