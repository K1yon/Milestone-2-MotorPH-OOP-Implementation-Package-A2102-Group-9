...
public class LoginPanel extends JPanel {
    ...
    private JPanel buildBrandPanel() {
        ...
        JLabel desc = new JLabel("<html><div style='text-align:center;color:#FFCCCC;"
    ...
    private JPanel buildFormPanel() {
        ...
        JLabel footer = new JLabel("<html><div style='text-align:center;"
            + "color:#AAAAAA;font-size:10px'>© 2024 MotorPH Corporation."
            + " All rights reserved.</div></html>");
    ...
    private void onLoginSuccess() {
        ...
        if (user.isHRAdmin()) {
            new HRDashboardFrame(loginController).setVisible(true);
        } else {
            new EmployeePortalFrame(user).setVisible(true);
        }
    }
    ...
    private void shakeWindow() {
        ...
        t.addActionListener(e -> {
            if (i[0] < dx.length) {
                parentFrame.setLocation(orig.x + dx[i[0]++], orig.y);
            } else {
