...
/**
 * Business-logic service for leave-request operations.
 *
 * OOP Principles:
 * - Single Responsibility: translates business rules into DAO calls.
 * - Dependency: uses LeaveRequestDAO for persistence (separation of layers).
 * - Encapsulation: callers don't need to know about file formats.
 */
